...
export const getCommits = catchAsyncError(async (req, res, next) => {
...
export const getRepoTree = catchAsyncError(async (req, res, next) => {
  ...
  try {
    ...
    if (err.response && err.response.status === 404 && branchToFetch === "main") {
